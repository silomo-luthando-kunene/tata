...
1. **Task 1: **Objective:** - Evaluated the integrity of Geldium’s financial datasets via Exploratory Data Analysis techniques to establish a reliable foundation for delinquency modeling. 
